...
public class ClosedPatterns {
	...
	public static void main(String[] args) throws IOException {
		...
		String input = fileToPath("DiscretizedD.txt");  // the database
		String output = "C://MS-Summer//Data Mining//DataMining Workspace//Project2//src//ClosedAndMG.txt";  // the path for saving the frequent itemsets found
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = ClosedPatterns.class.getResource(filename);
